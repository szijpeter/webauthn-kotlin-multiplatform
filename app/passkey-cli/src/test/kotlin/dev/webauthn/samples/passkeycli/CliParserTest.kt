...
class CliParserTest {
    ...
    fun parseDoctor_acceptsCommonOptions() {
        ...
        val invocation = parser.parse(
            arrayOf(
                ...
                "--python-bridge",
                "/repo/app/passkey-cli/scripts/fido2_bridge.py",
                "--authenticator",
                "ctap",
            ),
        )
        ...
        assertEquals("/repo/app/passkey-cli/scripts/fido2_bridge.py", invocation.common.pythonBridgePath)
    }
    ...
    fun parseRegister_usesLocalPropertiesDefaults_whenPresent() {
        ...
        val parserCwd = rootDir.resolve("app/passkey-cli").createDirectories()
