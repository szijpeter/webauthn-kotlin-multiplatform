...
if [[ "$scope" == "full" ]]; then
    ...
    for module in "${modules[@]}"; do
        [[ -z "$module" ]] && continue
        case "$module" in
            core:webauthn-cbor-core|core:webauthn-model|core:webauthn-runtime-core|core:webauthn-core|core:webauthn-json-kotlinx|core:webauthn-crypto-api|client:webauthn-client-core|client:webauthn-client-json-core|client:webauthn-client-compose|client:webauthn-client-prf-crypto|client:webauthn-network-ktor-client)
