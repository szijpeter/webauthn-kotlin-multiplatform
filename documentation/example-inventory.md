...
| docs-architecture-mermaid-4 | docs/architecture.md:149 | JVM server stack | mermaid | consumer | illustrative | Markdown illustration | illustrative | Diagram is rendered by the Markdown host |
