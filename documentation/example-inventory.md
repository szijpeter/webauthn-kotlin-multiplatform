...
| readme-kotlin-1 | README.md:162 | Install | kotlin | consumer | configuration | documentation/consumer-smoke/repositories.gradle.kts#consumer-repositories | consumer-compile |  |
| readme-kotlin-4 | README.md:178 | Recommended client setup | kotlin | consumer | configuration | documentation/consumer-smoke/defaults/build.gradle.kts.template#consumer-defaults-kmp-dependencies | consumer-compile |  |
| readme-kotlin-2 | README.md:212 | Compose your stack | kotlin | consumer | configuration | documentation/consumer-smoke/client/build.gradle.kts.template#consumer-client-kmp-dependencies | consumer-compile |  |
| readme-kotlin-3 | README.md:237 | Compose your stack | kotlin | consumer | configuration | documentation/consumer-smoke/server/build.gradle.kts.template#consumer-server-dependencies | consumer-compile |  |
| readme-bash-1 | README.md:258 | Compose your stack | bash | maintainer | markdown | Markdown block | syntax |  |
| readme-bash-2 | README.md:351 | Maintainer Workflow | bash | maintainer | markdown | Markdown block | syntax |  |
...
| client-webauthn-client-prf-crypto-readme-kotlin-1 | client/webauthn-client-prf-crypto/README.md:46 | How to use | kotlin | consumer | source | documentation/examples/src/commonMain/kotlin/dev/webauthn/documentation/examples/PrfCryptoExample.kt#prf-crypto | compile |  |
| core-webauthn-core-readme-kotlin-1 | core/webauthn-core/README.md:45 | How to use | kotlin | consumer | source | documentation/examples/src/commonMain/kotlin/dev/webauthn/documentation/examples/CoreValidationExample.kt#core-validation | compile |  |
| core-webauthn-core-readme-kotlin-2 | core/webauthn-core/README.md:122 | Composable extension hooks | kotlin | consumer | source | documentation/examples/src/commonMain/kotlin/examples/Composite.kt#composite-extension | compile |  |
...
| core-webauthn-model-readme-kotlin-1 | core/webauthn-model/README.md:45 | How to use | kotlin | consumer | source | documentation/examples/src/commonMain/kotlin/dev/webauthn/documentation/examples/ModelExample.kt#model-request-options | unit |  |
...
| site-compose-kotlin-1 | docs/site/content/mobile/compose.md:39 | Minimal state wiring | kotlin | consumer | sample | sample/compose-passkey/src/commonMain/kotlin/dev/webauthn/samples/composepasskey/ui/screens/auth/AuthRoute.kt#compose-sample-auth-route | sample-build |  |
| site-full-stack-bash-1 | docs/site/content/mobile/full-stack.md:33 | Local Android path | bash | consumer | markdown | Markdown block | syntax |  |
| site-full-stack-bash-2 | docs/site/content/mobile/full-stack.md:40 | Local Android path | bash | consumer | markdown | Markdown block | syntax |  |
| site-full-stack-bash-3 | docs/site/content/mobile/full-stack.md:53 | Physical-device path | bash | consumer | markdown | Markdown block | syntax |  |
