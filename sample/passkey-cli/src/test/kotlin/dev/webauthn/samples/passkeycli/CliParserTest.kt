...
class CliParserTest {
    ...
    fun parseDoctor_acceptsCommonOptions() {
        ...
        val invocation = parser.parse(
            arrayOf(
                ...
                "--python-bridge",
                "/repo/sample/passkey-cli/scripts/fido2_bridge.py",
                "--authenticator",
                "ctap",
            ),
        )
        ...
        assertEquals("/repo/sample/passkey-cli/scripts/fido2_bridge.py", invocation.common.pythonBridgePath)
    }
    ...
    fun parseRegister_usesLocalPropertiesDefaults_whenPresent() {
        ...
        val parserCwd = rootDir.resolve("sample/passkey-cli").createDirectories()
