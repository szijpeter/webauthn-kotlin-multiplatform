...
| `webauthn-protocol` | Beta | Codec-neutral interpretation of raw authenticator data and structural `authData` extraction from attestation objects, using only typed models and the strict CBOR scanner | Wider parser/vector coverage and higher-level raw-to-clean response conversion |
