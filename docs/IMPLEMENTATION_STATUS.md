...
| `webauthn-json-api` | Beta | Replaceable WebAuthn-specific JSON codec boundary for typed options, raw credential responses, and signed client-data decoding, adopted by neutral client/platform and server boundaries without selecting an implementation | Wider independent-codec and cross-implementation compatibility coverage |
