...
| `webauthn-client-core` | Beta | Shared typed ceremony orchestration (`DefaultPasskeyClient`), central raw-to-clean protocol conversion from platform bridges, deterministic invalid-options vs platform error behavior, coroutine cancellation passthrough, capability model | More extension-focused policy helpers and fixture coverage |
