...
| Client | `webauthn-client-core`, `webauthn-client-flow`, `webauthn-client-json-core`, `webauthn-client-compose`, `webauthn-client-platform`, `webauthn-client-prf-crypto`, `webauthn-network-ktor-client` | Raw client contract, state-free ceremony flow, platform bridges, Compose helpers, transport, and PRF crypto helpers |
...
- Client: `webauthn-client-core`, `webauthn-client-flow`, `webauthn-client-json-core`, `webauthn-client-compose`, `webauthn-client-platform`, `webauthn-client-prf-crypto`, `webauthn-network-ktor-client`
