...
- `webauthn-client-core` owns typed platform-operation behavior, `webauthn-client-flow` owns generic ceremony sequencing, and Android/iOS source sets stay thin.
